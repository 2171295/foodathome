        ...
        <div>
            ...
            <div class="div-radio">
                ...
                <input
                    ...
                    v-model="msgDestination"
                >
                <label for="destination_cook">Cookers</label>
                <input
                    type="radio"
                    id="destination_deliverymen"
                    value="ED"
                    v-model="msgDestination"
                >
                <label for="destination_deliverymen">Deliverymens</label>
                <input
                    type="radio"
                    id="destination_managers"
                    value="EM"
                    v-model="msgDestination"
                >
                <label for="destination_managers">Managers</label>
            </div>
        </div>
        <div>
      <textarea
